    ...
    export const CATEGORIES =[
        ...
        { key: "Material Escolar", label:"Material Escolar", icon: "bxs-school"},
        { key: "Escritório", label:"Escritório", icon: "bx-briefcase"},
        { key: "Papelaria", label:"Papelaria", icon: "bx-file"},
        { key: "Promoções", label:"Promoções", icon: "bx-tag" },        
    ];